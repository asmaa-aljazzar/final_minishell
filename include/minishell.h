...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-08-16 10:45:55 by baal-moh          #+#    #+#             */
/*   Updated: 2025-08-16 10:45:55 by baal-moh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_token
{
	...
	int		glued;
/*1 → directly attached to previous 
char 0 → at least one white-space before it*/
}								t_token;
