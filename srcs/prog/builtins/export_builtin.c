...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/16 16:26:09 by aaljazza          #+#    #+#             */
/*   Updated: 2025/08/16 16:32:18 by aaljazza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_existing_env(t_minishell *shell, t_env *var, char *name,
		char *value)
{
	static char	*str = "./minishell: warning: shell level (1000) too high\n";
